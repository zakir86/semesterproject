...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employee set Name='"+t1.getText()+"',Father_Name='"+t2.getText()+"',Age='"+age+"',Date_of_birth='"+dat+"',Addess='"+t3.getText()+"',Phone='"+t4.getText()+"',Email_Id='"+t5.getText()+"',Education='"+t6.getText()+"',Job_post='"+t7.getText()+"',CNIC='"+t8.getText()+"',Employee_Id='"+t9.getText()+"' where emp_id='"+id_emp+"'";
